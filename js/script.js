document.addEventListener('DOMContentLoaded', function() {
    ...
    function renderEditForm(data) {
        ...
        hobbiesTextarea.value = data.sections.hobbies.text || '';

        // Populate contact links
        data.contact.forEach(link => addContactLinkField(link));
    ...
    // FAB Logic (for cv.html, but included here for completeness of script.js)
    if (fabMainButton) {
